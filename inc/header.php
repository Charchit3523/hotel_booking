...
<!-- <div class="modal fade" id="registerModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action ="code.php" methood ="POST"id="register-form">
                <div class="modal-header">
                    <h5 class="modal-title d-flex align-items-center" id="staticBackdropLabel">
                        <i class="bi bi-person-square fs-3 me-2"></i>User Registration
                    </h5>
                    <button type="reset" class="btn-close shadow-none" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                <span class="badge rounded-pill bg-light text-dark mb-5 text-wrap lh-base" style="display: block;">
                    Note: Your details must match with your Id( Citizenship card,  driving  license, passport, etc.)<br>
                ...
                <div class="container-fluid my-1">
                    ...
                    <div class="text-center">
                        <button type="submit" name="register_btn" class="btn btn-dark shadow-none">
                            Register
                        </button>
                    </div>
                </div>
